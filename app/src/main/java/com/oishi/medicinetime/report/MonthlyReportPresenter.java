...
public class MonthlyReportPresenter implements MonthlyReportContract.Presenter {
    ...
    private final MonthlyReportContract.Vieww mMonthlyReportView;

    private FilterType mCurrentFilteringType = FilterType.ALL_MEDICINES;

    public MonthlyReportPresenter(@NonNull MedicineRepository medicineRepository, MonthlyReportContract.Vieww monthlyReportView) {
